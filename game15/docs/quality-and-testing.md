...
`release.sh game15` automatically:

1. Runs `optimize_audio.sh game15` — transcodes any new WAV/MP3/FLAC under `public/music/` and `public/sfx/` to Ogg Vorbis. Idempotent.
