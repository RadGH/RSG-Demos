const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-BgUhedSF.js","./main-D2c3OVlN.css"])))=>i.map(i=>d[i]);
import{U as Y,D as u,W as l,S as k,E as T,C as E,d as U,_ as G}from"./main-BgUhedSF.js";import{s as B,n as F}from"./Noise-Cgm4OGP4.js";import{c as K}from"./RNG-ziO0lLz6.js";import{H}from"./HUDPanel-BJFBlcWs.js";import{G as b}from"./Graphics-Cvy4womD.js";const D={might:"Might",agility:"Agility",wit:"Wit",presence:"Presence",endurance:"Endurance",attunement:"Attunement"},O={dialog:{label:"Encounter",color:"#c8a020"},combat:{label:"Ambush",color:"#c83020"},merchant:{label:"Traveler",color:"#4a9a4a"},shrine:{label:"Shrine",color:"#7a5aba"},discovery:{label:"Discovery",color:"#2a8aaa"},rest:{label:"Rest Site",color:"#4a7a4a"},trap:{label:"Danger",color:"#c83020"},default:{label:"Encounter",color:"#c8a020"}};class W extends Y{constructor(){super("panel-encounter-dialog",{trapFocus:!0,zLayer:"modal"}),this._encounter=null,this._partyChars=null,this._onComplete=null,this._inResultPhase=!1,this._chosenIndex=null,this._keyHandler=e=>this._onKeydown(e)}show(e,t,n){this._encounter=e,this._partyChars=t??[],this._onComplete=n??null,this._inResultPhase=!1,this._chosenIndex=null,this._renderEncounter(),this._addDarkOverlay(),window.addEventListener("keydown",this._keyHandler),super.show(),this._focusFirstOption(),u.event(`[encounter] Dialog shown; id=${e?.id??"unknown"} title="${e?.title??""}" options=${e?.options?.length??0}`)}hide(){window.removeEventListener("keydown",this._keyHandler),this._removeDarkOverlay(),super.hide(),this._encounter=null,this._partyChars=null,this._onComplete=null}_renderEncounter(){const e=this._encounter;if(!e)return;const t=O[e.type]??O.default,n=e.options??[],i=n.map((r,s)=>this._renderOption(r,s)).join("");this.el.innerHTML=`
...
`,A=new W,h=32,f=40,g=30,z=3,R=8,M=160,L=120,q=12,j={ocean:"water",frozen_sea:"water",tundra:"snow",taiga:"forest",forest:"forest",plains:"grass",desert:"sand",jungle:"forest",mountain:"mountain",volcanic:"mountain",archipelago:"sand"},X={grass:4880938,forest:2775578,mountain:8022618,water:1718876,sand:13150810,snow:15263984,road:9075290},Z={grass:660480,forest:528394,mountain:1051656,water:266272,sand:1576968,snow:526344,road:788488};class ie{async init({renderer:e,regionId:t}={}){if(this._renderer=e,this._regionId=t??l.currentRegionId??0,this._panel=null,this._tileContainer=null,this._fogTileContainer=null,this._partyContainer=null,this._minimapContainer=null,this._minimapGfx=null,this._camera={x:0,y:0},this._partyX=l.partyPosition.x,this._partyY=l.partyPosition.y,this._moveAccum={x:0,y:0},this._ticker=null,this._resizeUnsub=null,this._fogUpdateUnsub=null,this._fogDirty=!0,this._encounterActive=!1,this._distanceSinceCheck=0,this._encounterCooldown=0,this._prevTileX=null,this._prevTileY=null,window.__debug=window.__debug??{},window.__debug.currentScene="localMap",window.__debug.getLocalMap=()=>({regionId:this._regionId,gridW:f,gridH:g,partyX:Math.floor(this._partyX),partyY:Math.floor(this._partyY),tileCount:this._tiles?this._tiles.length:0}),!l.world){u.error("[world] LocalMapScene: no world data"),k.transition("worldMap");return}l.currentRegionId=this._regionId,l.currentLocalMapId=this._regionId,l.exploreRegion(this._regionId),this._tiles=this._getOrGenerateLocalMap(),this._buildPixiTiles(),this._buildPixiParty(),this._buildMinimap(),this._buildHTMLPanel(),window.__settings?.fogOfWar&&l.revealAround(Math.floor(this._partyX),Math.floor(this._partyY),R),this._fogDirty=!0,this._ticker=n=>this._update(n.deltaMS),this._renderer.app.ticker.add(this._ticker),this._resizeUnsub=T.on("renderer:resize",()=>this._onResize()),this._fogUpdateUnsub=T.on("fog:update",()=>{this._fogDirty=!0}),H.init(),this._showOnboardingHint(),this._buildMobileDpad(),this._updatePartyPosition(),this._updateCamera(),window.__worldState=l,u.info(`[world] LocalMapScene initialized; regionId=${this._regionId} tiles=${this._tiles.length}`)}_getOrGenerateLocalMap(){const e=l.getLocalMap(this._regionId);if(e)return e.tiles;const t=l.world.regions.find(c=>c.id===this._regionId),n=t?.biome??"plains",i=j[n]??"grass",r=(l.world.seed^this._regionId*1514109713)>>>0;B(r);const s=K(r),o=[],a=.12;for(let c=0;c<g;c++)for(let d=0;d<f;d++){const m=F(d*a,c*a,4,.5,2);let p=i;i==="grass"?m>.72?p="forest":m<.18&&(p="water"):i==="forest"?m>.78?p="mountain":m<.15&&(p="grass"):i==="mountain"?m<.25?p="grass":m<.4&&(p="forest"):i==="snow"?m>.7&&(p="mountain"):i==="sand"&&(m<.15?p="water":m>.8&&(p="grass"));const _=X[p]??4473924,x=Z[p]??526344,v=s.nextInt(0,3);let w=_;if(v===0){const C=x>>16&255,y=x>>8&255,I=x&255,$=_>>16&255,P=_>>8&255,S=_&255;w=Math.min(255,$+C)<<16|Math.min(255,P+y)<<8|Math.min(255,S+I)}else if(v===1){const C=x>>16&255,y=x>>8&255,I=x&255,$=_>>16&255,P=_>>8&255,S=_&255;w=Math.max(0,$-C)<<16|Math.max(0,P-y)<<8|Math.max(0,S-I)}o.push({x:d,y:c,type:p,color:w,passable:p!=="water"&&p!=="mountain"})}return this._addRoadTiles(o,t),l.setLocalMap(this._regionId,{tiles:o,gridW:f,gridH:g}),o}_addRoadTiles(e,t){if(!t||!l.world.spellroads)return;const n=l.world,i=t.centerX/n.gridW,r=t.centerY/n.gridH;for(const s of n.spellroads)if(s.find(a=>{const c=a.x-i,d=a.y-r;return Math.sqrt(c*c+d*d)<.15})){for(let a=0;a<f;a++){const c=Math.floor(g/2)+Math.round(Math.sin(a*.3)*1.5);if(c>=0&&c<g){const d=e[c*f+a];d&&d.type!=="water"&&(d.type="road",d.color=X.road,d.passable=!0)}}break}}_buildPixiTiles(){const e=this._renderer.layers.world;this._tileContainer=new E,this._tileContainer.label="localTiles",e.addChild(this._tileContainer);const t=new b;for(const n of this._tiles){const i=n.x*h,r=n.y*h;t.rect(i,r,h,h),t.fill({color:n.color})}this._tileContainer.addChild(t),this._fogTileContainer=new E,this._fogTileContainer.label="localFog",e.addChild(this._fogTileContainer)}_rebuildFogTiles(){if(!this._fogTileContainer)return;if(!window.__settings?.fogOfWar){this._fogTileContainer.removeChildren(),this._fogDirty=!1;return}this._fogTileContainer.removeChildren();const e=new b;for(let t=0;t<g;t++)for(let n=0;n<f;n++){const i=l.getFogAt(this._regionId,n,t);if(i===2)continue;const r=n*h,s=t*h,o=i===0?.9:.4;e.rect(r,s,h,h),e.fill({color:0,alpha:o})}this._fogTileContainer.addChild(e),this._fogDirty=!1}_buildPixiParty(){this._partyContainer=new E,this._partyContainer.label="partyToken",this._renderer.layers.entities.addChild(this._partyContainer),this._partyGfx=new b,this._partyContainer.addChild(this._partyGfx),this._drawPartyGfx()}_drawPartyGfx(){if(!this._partyGfx)return;this._partyGfx.clear();const e=0,t=0,n=10;this._partyGfx.circle(e,t,n+4),this._partyGfx.fill({color:16768256,alpha:.2}),this._partyGfx.circle(e,t,n),this._partyGfx.fill({color:16768256}),this._partyGfx.circle(e,t,n),this._partyGfx.stroke({color:16777215,width:2}),this._partyGfx.moveTo(e-6,t),this._partyGfx.lineTo(e+6,t),this._partyGfx.moveTo(e,t-6),this._partyGfx.lineTo(e,t+6),this._partyGfx.stroke({color:16777215,width:1.5})}_updatePartyPosition(){if(!this._partyContainer)return;const e=Math.floor(this._partyX)*h+h/2,t=Math.floor(this._partyY)*h+h/2;this._partyContainer.x=e,this._partyContainer.y=t}_updateCamera(){const e=this._renderer.width,t=this._renderer.height,n=-(Math.floor(this._partyX)*h+h/2-e/2),i=-(Math.floor(this._partyY)*h+h/2-t/2);this._camera.x=n,this._camera.y=i,this._tileContainer&&(this._tileContainer.x=this._camera.x,this._tileContainer.y=this._camera.y),this._fogTileContainer&&(this._fogTileContainer.x=this._camera.x,this._fogTileContainer.y=this._camera.y)}_onResize(){this._updateCamera(),this._updateMinimap(),this._repositionMinimap()}_update(e){const t=e/1e3;if(this._encounterActive)return;const n=U.getState(0),i=n.moveAxis.x,r=n.moveAxis.y;let s=!1;if(i!==0||r!==0){const o=Math.sqrt(i*i+r*r),a=i/o,c=r/o,d=a*z*t,m=c*z*t,p=this._partyX+d,_=this._partyY+m,x=Math.max(0,Math.min(f-1,p)),v=Math.max(0,Math.min(g-1,_)),w=Math.floor(x),C=Math.floor(v),y=this._tiles[C*f+w];y&&y.passable&&(this._partyX=x,this._partyY=v,s=!0)}if(s){const o=Math.floor(this._partyX),a=Math.floor(this._partyY);if(l.partyPosition.x=o,l.partyPosition.y=a,window.__settings?.fogOfWar&&l.revealAround(o,a,R),this._fogDirty=!0,T.emit("local:partyMoved",{x:o,y:a}),o!==this._prevTileX||a!==this._prevTileY){this._prevTileX=o,this._prevTileY=a;const d=this._tiles[a*f+o];if(d?.type==="dungeon"){this._promptDungeonEntry(d);return}this._advanceTimeForTile(o,a),this._distanceSinceCheck+=1,this._encounterCooldown>0&&(this._encounterCooldown-=1),this._distanceSinceCheck>=3&&this._encounterCooldown<=0&&(this._distanceSinceCheck=0,this._checkForEncounter(o,a))}}this._updatePartyPosition(),this._updateCamera(),this._fogDirty&&(this._rebuildFogTiles(),this._updateMinimap())}_checkForEncounter(e,t){const n=window.__encounterSystem??null;if(!n?.checkMovementEncounter)return;const i=l.getRegion(this._regionId),r=this._tiles[t*f+e],s={x:e,y:t,regionId:this._regionId,biome:i?.biome??"plains",tileType:r?.type??"grass",partyGold:l.partyGold,isNight:this._checkIsNight()};let o=null;try{o=n.checkMovementEncounter(s)}catch(a){u.warn(`[encounter] checkMovementEncounter failed: ${a.message}`);return}if(o)if(u.event(`[encounter] Encounter triggered; type=${o.type} id=${o.id??"unknown"} tile=${e},${t}`),this._encounterCooldown=8,o.type==="combat"){const a=window.__partyChars??[],c=o.enemies??[];k.transition("combat",{partyChars:a,enemies:c,sourceEncounter:o})}else this._showEncounterDialog(o)}_showEncounterDialog(e){this._encounterActive=!0;const t=window.__partyChars??[];A.show(e,t,n=>{this._encounterActive=!1,n&&(u.event(`[encounter] Dialog resolved; passed=${n.passed??!1} success=${n.success??"n/a"}`),n.goldDelta!=null&&(l.partyGold=Math.max(0,(l.partyGold??0)+n.goldDelta),H.update()),T.emit("encounter:resolved",{encounter:e,result:n}))})}_promptDungeonEntry(e){if(document.getElementById("dungeon-entry-prompt"))return;this._encounterActive=!0;const n=e.dungeonType??"burial_mound",i=e.dungeonName??n.replace(/_/g," ").replace(/\b\w/g,a=>a.toUpperCase()),r=((l.world?.seed??12345)^e.x*31295+e.y*7033)>>>0,s=l.currentRegionLevel??1,o=document.createElement("div");o.id="dungeon-entry-prompt",o.style.cssText=`
    ...
    `;const n=[{id:"up",label:"▲",top:"0",left:"40px",dx:0,dy:-1},{id:"down",label:"▼",top:"80px",left:"40px",dx:0,dy:1},{id:"left",label:"◀",top:"40px",left:"0",dx:-1,dy:0},{id:"right",label:"▶",top:"40px",left:"80px",dx:1,dy:0}];for(const i of n){const r=document.createElement("button");r.textContent=i.label,r.style.cssText=`
      ...
      `,r.addEventListener("pointerdown",s=>{s.preventDefault(),G(()=>import("./main-BgUhedSF.js").then(o=>o.aq),__vite__mapDeps([0,1]),import.meta.url).then(o=>{o.default._states[0].moveAxis.x=i.dx,o.default._states[0].moveAxis.y=i.dy})}),r.addEventListener("pointerup",()=>{G(()=>import("./main-BgUhedSF.js").then(s=>s.aq),__vite__mapDeps([0,1]),import.meta.url).then(s=>{s.default._states[0].moveAxis.x=0,s.default._states[0].moveAxis.y=0})}),r.addEventListener("pointerleave",()=>{G(()=>import("./main-BgUhedSF.js").then(s=>s.aq),__vite__mapDeps([0,1]),import.meta.url).then(s=>{s.default._states[0].moveAxis.x=0,s.default._states[0].moveAxis.y=0})}),t.appendChild(r)}document.body.appendChild(t),this._dpadEl=t}_buildHTMLPanel(){const e=document.getElementById("panel-local-map-hud");e&&e.remove();const t=document.createElement("div");t.id="panel-local-map-hud",t.style.cssText=`
      position: fixed;
      top: 12px;
      right: 12px;
