const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-DuN4PVib.js","./main-D2c3OVlN.css"])))=>i.map(i=>d[i]);
import{D as c,O as d,_ as u,E as x,S as y,U as _}from"./main-DuN4PVib.js";const f="spellroads-online-lobby-style";function v(){if(document.getElementById(f))return;const p=document.createElement("style");p.id=f,p.textContent=`
...
//# sourceMappingURL=MainMenuScene-DLLJzGZc.js.map
