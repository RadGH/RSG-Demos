const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./SkillSystem-BT1zZrS4.js","./main-C9yvU6FC.js","./main-D2c3OVlN.css"])))=>i.map(i=>d[i]);
import{U as L,b as m,D as k,_ as P}from"./main-C9yvU6FC.js";let u=null;async function q(){if(u)return u;try{return u=(await P(()=>import("./SkillSystem-BT1zZrS4.js"),__vite__mapDeps([0,1,2]),import.meta.url)).default,u}catch(d){return k.warn(`[skill] SkillSystem not available: ${d.message}`),null}}const v="spellroads-skilltree-style";function C(){if(document.getElementById(v))return;const d=document.createElement("style");d.id=v,d.textContent=`
    /* ══════════════════════════════════════════════════════════════
...
//# sourceMappingURL=SkillTreePanel-D7-8CF7A.js.map
