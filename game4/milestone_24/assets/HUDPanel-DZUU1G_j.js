import{E as h,D as o,W as r}from"./main-C9yvU6FC.js";const c={clear:"☀️",cloudy:"☁️",rainy:"🌧️",stormy:"⛈️",snow:"🌨️",foggy:"🌫️",hot:"🔥",blizzard:"❄️",windy:"💨",frozen:"❄️"};class u{constructor(){this._el=null,this._intervalId=null,this._active=!1,this._formatTime=null,this._isNight=null,this._heading=0,this._weatherUnsub=null}init(e={}){this.destroy(),this._formatTime=e.formatTime??this._getTimeFn("formatTime"),this._isNight=e.isNight??this._getTimeFn("isNight"),this._buildDOM(),this.update(),this._intervalId=setInterval(()=>this.update(),1e3),this._active=!0,this._weatherUnsub=h.on("weather:changed",t=>{this._updateWeatherDisplay(t)}),this._syncWeatherDisplay(),o.info("[debug] HUDPanel initialized")}update(){if(!this._el)return;const e=this._el.querySelector("#hud-time"),t=this._el.querySelector("#hud-gold"),s=this._el.querySelector("#hud-rations"),a=this._el.querySelector("#hud-night-indicator"),i=this._getFormattedTime(),n=this._checkIsNight(),l=r.partyGold??0,d=r.rationPoints??0;e&&(e.textContent=i),t&&(t.textContent=`${l}g`),s&&(s.textContent=`${d} rations`),a&&(a.style.display=n?"inline-block":"none"),document.body.classList.toggle("hud-night-mode",n)}destroy(){this._intervalId!=null&&(clearInterval(this._intervalId),this._intervalId=null),this._weatherUnsub&&(this._weatherUnsub(),this._weatherUnsub=null),this._el&&(this._el.remove(),this._el=null),document.body.classList.remove("hud-night-mode"),this._active=!1,o.info("[debug] HUDPanel destroyed")}setHeading(e){this._heading=e%360;const t=this._el?.querySelector(".hud-compass-needle");t&&(t.style.transform=`rotate(${this._heading}deg)`)}_syncWeatherDisplay(){try{const e=window.__weatherSystem;e&&this._updateWeatherDisplay(e.getCurrentWeather())}catch{}}_updateWeatherDisplay(e){const t=this._el?.querySelector("#hud-weather");if(!t||!e)return;const s=c[e.weather]??"☀️",a=i=>i?i.charAt(0).toUpperCase()+i.slice(1):"";t.textContent=`${s} ${a(e.season)}`}_buildDOM(){document.getElementById("hud-panel-root")?.remove();const e=document.createElement("div");if(e.id="hud-panel-root",e.setAttribute("aria-hidden","true"),e.innerHTML=`
      <div id="hud-top-bar">
...
`,y=new u;export{y as H};
//# sourceMappingURL=HUDPanel-DZUU1G_j.js.map
