import{i as U,c as R,j as K,G as w,p as W,k as X,s as G,t as V,h as D,v as Y,w as J,y as Q,z as Z,B as O,D as tt,E as B,F as et,H as P,I as A,J as F,r as $,K as ot,L as st,M as it,N as at,O as nt}from"./play-DTi89_fw.js";import"./modulepreload-polyfill-B5Qt9EMX.js";import"./savesClient-wbDfy9Yw.js";import"./version-CwZysYMM.js";const rt=["weapon","offhand","head","chest","legs","hands","feet","ring1","ring2","necklace"],lt={weapon:"Weapon",offhand:"Off-hand",head:"Head",chest:"Chest",legs:"Legs",hands:"Hands",feet:"Feet",ring1:"Ring",ring2:"Ring",necklace:"Necklace"};function ct(C,e,t){var m;const u=[...e.inventory||[]];let n=0;for(const a of u){if((m=e.isManuallyUnequipped)!=null&&m.call(e,a.id))continue;const f=C.autoEquip;C.autoEquip=!0;try{const i=e.tryAutoEquip(a);i&&i.member&&i.member.id===C.id&&n++}catch{}C.autoEquip=f}n>0&&t&&t.playSfx("purchase")}class gt{constructor(e,t){this.manager=e,this.audio=t,this._el=null,this._selectedCharIdx=0,this._charScrollPos=new Map,this._tt=null,this._compareMode=!1,this._compareSecondary=!1,this._currentTooltipItem=null,this._isTouch=typeof window<"u"&&("ontouchstart"in window||navigator.maxTouchPoints>0)}onEnter(){this._build()}_build(){U("inv-styles",dt),this._el=R("div","inv-screen"),this.manager.uiOverlay.appendChild(this._el),this._render()}_render(){K(this._el,()=>this._renderImpl())}_renderImpl(){const e=w.get(),u=(e.inventoryContext||"default")==="party-inactive",n=e.bench||[],m=u?[...e.party,...e.companions,...n]:[...e.party,...e.companions];if(e.inventoryFocusId){const i=m.findIndex(h=>h.id===e.inventoryFocusId);i>=0&&(this._selectedCharIdx=i),e.inventoryFocusId=null}const a=m[this._selectedCharIdx]||m[0];this._selectedCharIdx>=m.length&&(this._selectedCharIdx=0),this._el.innerHTML=`
    ...
    `,this._wireEvents(),G(this._el);const f=this._el.querySelector("#stats-base-chk");f&&f.addEventListener("click",()=>{var s,o;const i=(s=this._el)==null?void 0:s.querySelector(".equip-panel"),h=i?i.scrollTop:0,g=!f.classList.contains("on");V(g),this.audio.playSfx("click"),this._render();const x=(o=this._el)==null?void 0:o.querySelector(".equip-panel");x&&(x.scrollTop=h)})}_slotsForItem(e,t){if(!t||!e)return[];const u=[];return t.type==="weapon"?(u.push("weapon"),(t.offHandOk||!t.twoHanded)&&!t.twoHanded&&u.push("offhand"),u):t.subtype==="ring"||t.slot==="ring"?["ring1","ring2"]:t.slot?[t.slot]:t.subtype?[t.subtype]:[]}_upgradeTier(e,t){var f;if(!e||!t||e.isCompanion&&e.class==="companion")return null;const u=this._slotsForItem(e,t);if(!u.length)return null;const n=e.equipment||{};for(const i of u)if(!n[i]){if(i==="offhand"&&((f=n.weapon)!=null&&f.twoHanded))continue;return"empty"}const m=D(t,e).total;let a=-1/0;for(const i of u){const h=n[i];if(!h)continue;const g=D(h,e).total;if(g<=0)continue;const x=(m-g)/g;x>a&&(a=x)}return a<=0||a===-1/0?null:a<=.05?"minor":a<=.2?"medium":a<=.5?"major":"huge"}_vsItemForCompare(e,t){if(!e||!t)return null;const u=e.equipment||{},n=this._slotsForItem(e,t);if(!n.length)return null;let m=n[0],a=n[1];n.includes("ring1")&&n.includes("ring2")&&(m="ring1",a="ring2");const f=this._compareSecondary&&a?a:m;return{vs:u[f]||null,slot:f,hasSecondary:!!a&&a!==m}}_renderCharStats(e){if(!e)return'<div class="stat-row"><span>No character selected</span></div>';const t=e.baseAttrs||e.attrs,u=e.attrs,n=Y(),m=e.equipment||{};let a=0;for(const p of Object.values(m))p!=null&&p.armor&&(a+=p.armor);const f=0,i=J(e);a+=i.armor||0;const h=Q(m),g=n?t:{STR:u.STR+(i.str||0),DEX:u.DEX+(i.dex||0),INT:u.INT+(i.int||0),CON:u.CON+(i.con||0)},x=Z(m)+(i.dmg||0),s=O(g,n?0:x,h),o=O(t,0,h),d=h==="magic"?"Magic Damage":h==="light"?"Light Damage":"Heavy Damage",r=n?0:i.magicResist||0,l=(p,y)=>({hp:y?st(e):50+p.CON*10,mp:y?ot(e):30+p.INT*8,hit:Math.min(95,70+Math.round(p.DEX*1.2)+(y&&i.hit||0)),dodge:Math.min(40,5+Math.round(p.DEX*.8)+(y&&i.dodge||0)),spl:p.INT*.025+(y&&i.spellPower||0)}),c=l(n?t:g,!n),b=l(t,!1),v=n?f:a,S=n?0:tt(e).resistAll||0,q=B(v,S),M=B(f,0),_=(p,y,E)=>{const z=it(y,E,p);return z?` style="color:${z}"`:""},H=["STR","DEX","INT","CON"].map(p=>{const y=p.toLowerCase(),E=g[p];return`<div class="stat-row"><span class="sr-label stat-label" data-stat="${p}">${p}</span><span class="sr-val"${_(y,E,t[p])}>${Math.floor(E)}</span></div>`}).join(""),T=new Set(["str","dex","int","con","hp","mp","dmg","armor","hit","dodge","magicresist","magicResist","spellpower","spellPower"]),L={goldFind:"Gold Find",xpFind:"XP Find",manaRegen:"Mana Regen",lifeSteal:"Life Steal",manaSteal:"Mana Steal",initiative:"Initiative",critChance:"Crit Chance",critDamage:"Crit Damage",spellPower:"Spell Power",tradePrices:"Trade Prices"},k=[];if(!n){try{const p=et(e);if((p==null?void 0:p.blockChance)>0){const y=`+${P(p.blockChance)}`;k.push(`<div class="stat-row"><span class="sr-label stat-label" data-stat="Block Chance">Block Chance</span><span class="sr-val" style="color:#6db3ff">${y}</span></div>`)}(p==null?void 0:p.blockPower)>0&&k.push(`<div class="stat-row"><span class="sr-label stat-label" data-stat="Block Power">Block Power</span><span class="sr-val" style="color:#6db3ff">+${Math.round(p.blockPower)}</span></div>`)}catch{}for(const p of Object.keys(i)){if(T.has(p)||T.has(p.toLowerCase()))continue;const y=i[p];if(!y)continue;const E=L[p]||p.replace(/([A-Z])/g," $1").replace(/^./,j=>j.toUpperCase()),N=(p==="goldFind"||p==="xpFind"||p==="critChance"||p==="critDamage"||p==="tradePrices")&&Math.abs(y)<=3?`+${P(y)}`:p==="lifeSteal"||p==="manaSteal"?`+${A(y,"pct")}`:`+${A(y,"auto")}`;k.push(`<div class="stat-row"><span class="sr-label stat-label" data-stat="${E}">${E}</span><span class="sr-val" style="color:#6db3ff">${N}</span></div>`)}}const I=k.length?k.join(""):'<div class="stat-row"><span class="sr-label" style="color:#5a4a42;font-style:italic">None</span><span class="sr-val" style="color:#5a4a42">—</span></div>';return`
      ...
      <div class="stat-row"><span class="sr-label stat-label" data-stat="Damage Reduction">Damage Reduction</span><span class="sr-val"${_("dmgReduction",q.totalDr,M.totalDr)}>${P(q.totalDr)}</span></div>
    ...
    `,t.querySelector("#info-ok").addEventListener("click",()=>$(t)),t.addEventListener("click",u=>{u.target===t&&$(t)}),this._el.appendChild(t)}_equipItemFlow(e){var h,g,x,s,o,d;const t=w.get(),n=[...t.party,...t.companions][this._selectedCharIdx];if(!n||!e)return;if(n.isCompanion&&n.class==="companion"){this._showInfoModal("Companions cannot equip items.");return}const m=e.type==="weapon",a=e.twoHanded,f=e.offHandOk||!a&&m;if(m&&!a&&f){const r=!!((h=n.equipment)!=null&&h.weapon),l=!!((g=n.equipment)!=null&&g.offhand),c=(s=(x=n.equipment)==null?void 0:x.weapon)==null?void 0:s.twoHanded;if(!r){this._doEquip(n,e,"weapon",t),this._render();return}if(!l&&!c){this._doEquip(n,e,"offhand",t),this._render();return}this._showSlotPicker(n,e,t);return}if(e.subtype==="ring"){const r=!!((o=n.equipment)!=null&&o.ring1),l=!!((d=n.equipment)!=null&&d.ring2);if(!r){this._doEquip(n,e,"ring1",t),this._render();return}if(!l){this._doEquip(n,e,"ring2",t),this._render();return}this._showRingPicker(n,e,t);return}let i=e.slot;i||(m?i="weapon":i=e.subtype),this._doEquip(n,e,i,t),this._render()}_wireEvents(){var x;(x=this._el.querySelector("#inv-close"))==null||x.addEventListener("click",()=>{this.audio.playSfx("click"),this.manager.pop()});const e=this._el.querySelector("#inv-autoequip");e&&e.addEventListener("click",()=>{this.audio.playSfx("click");const s=w.get(),d=[...s.party,...s.companions,...s.bench||[]][this._selectedCharIdx];if(!d)return;const r=!d.autoEquip;d.autoEquip=r,r&&ct(d,s,this.audio),this._render()}),this._el.querySelectorAll(".char-tab").forEach(s=>{s.addEventListener("click",()=>{this.audio.playSfx("click");const o=this._el.querySelector(".inv-items-panel")||this._el.querySelector(".equip-panel");o&&this._charScrollPos.set(this._selectedCharIdx,o.scrollTop),this._selectedCharIdx=parseInt(s.dataset.idx),this._render(),requestAnimationFrame(()=>{var r,l;const d=((r=this._el)==null?void 0:r.querySelector(".inv-items-panel"))||((l=this._el)==null?void 0:l.querySelector(".equip-panel"));d&&(d.scrollTop=this._charScrollPos.get(this._selectedCharIdx)||0)})})}),this._el.querySelectorAll("[data-equip]").forEach(s=>{s.addEventListener("click",()=>{var M,_,H,T,L,k;this.audio.playSfx("click");const o=s.dataset.equip,d=w.get(),l=[...d.party,...d.companions][this._selectedCharIdx],c=d.inventory.find(I=>I.id===o);if(!l||!c)return;if(l.isCompanion&&l.class==="companion"){this._showInfoModal("Companions cannot equip items.");return}const b=c.type==="weapon",v=c.twoHanded,S=c.offHandOk||!v&&b;if(b&&!v&&S){const I=!!((M=l.equipment)!=null&&M.weapon),p=!!((_=l.equipment)!=null&&_.offhand),y=(T=(H=l.equipment)==null?void 0:H.weapon)==null?void 0:T.twoHanded;if(!I){this._doEquip(l,c,"weapon",d),this._render();return}if(!p&&!y){this._doEquip(l,c,"offhand",d),this._render();return}this._showSlotPicker(l,c,d);return}if(c.subtype==="ring"){const I=!!((L=l.equipment)!=null&&L.ring1),p=!!((k=l.equipment)!=null&&k.ring2);if(!I){this._doEquip(l,c,"ring1",d),this._render();return}if(!p){this._doEquip(l,c,"ring2",d),this._render();return}this._showRingPicker(l,c,d);return}let q=c.slot;q||(b?q="weapon":q=c.subtype),this._doEquip(l,c,q,d),this._render()})}),this._el.querySelectorAll("[data-slot]").forEach(s=>{s.dataset.itemid&&s.addEventListener("click",()=>{var b;const o=w.get(),r=[...o.party,...o.companions][this._selectedCharIdx],l=s.dataset.slot;if(!((b=r==null?void 0:r.equipment)!=null&&b[l]))return;this.audio.playSfx("click");const c=r.equipment[l];w.markManuallyUnequipped(c.id),w.addToInventoryRaw(c),delete r.equipment[l],F(r),this._render()})});const t=this._el.querySelector("#inv-tt"),u=t==null?void 0:t.querySelector(".inv-tt-body"),n=t==null?void 0:t.querySelector(".inv-tt-close"),m=()=>{const s=w.get(),o=[...s.party,...s.companions,...s.bench||[]];return{gs:s,char:o[this._selectedCharIdx]}},a=s=>{const{gs:o,char:d}=m();return o.inventory.find(r=>r.id===s)||Object.values((d==null?void 0:d.equipment)||{}).find(r=>(r==null?void 0:r.id)===s)},f=s=>{var d;if(!u||!s)return;const{char:o}=m();if(this._compareMode){const r=this._vsItemForCompare(o,s),l=(r==null?void 0:r.vs)||null,c=(r==null?void 0:r.slot)||null;let b=null;r!=null&&r.hasSecondary&&(b=this._isTouch?'Tap "Compare 2nd" below to compare against the other slot.':"Hold Alt+Shift to compare against the other slot.");let v="";if(this._isTouch&&(v+=`<div class="tt-breadcrumb">Inventory <span class="bc-sep">›</span> ${s.name} <span class="bc-sep">›</span> <strong>Compare</strong></div>`),v+=at(s,l,{hero:o,slotLabel:c,secondaryHint:b}),this._isTouch){const S=!!((d=gs==null?void 0:gs.inventory)!=null&&d.find(q=>q.id===s.id));v+=`<div class="tt-cmp-actions">
            ...
            ${S?'<button type="button" class="tt-cmp-btn primary" data-cmp-action="equip">Equip</button>':""}
