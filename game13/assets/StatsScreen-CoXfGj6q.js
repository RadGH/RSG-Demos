import{e as M,i as j,c as B,u as w,r as D,m as P,g as A,a as R,p as F,b as H,d as K,A as S,f as G,G as N}from"./play-Crd1mzbS.js";import"./modulepreload-polyfill-B5Qt9EMX.js";import"./savesClient-Dh5r3e2b.js";import"./version-CB7aFKiR.js";function W(o,e,s={}){const t=o.getContext("2d"),a=window.devicePixelRatio||1,r=o.getBoundingClientRect();(o.width!==r.width*a||o.height!==r.height*a)&&(o.width=r.width*a,o.height=r.height*a),t.setTransform(a,0,0,a,0,0);const n=r.width,i=r.height;t.clearRect(0,0,n,i);const p=s.xKey||"t",x=s.yKey||"dps",m=s.color||"#e8a020",L="#5a4838",z="#8a7a6a",y=Object.assign({top:14,right:14,bottom:32,left:46},s.padding||{}),f=y.left,v=n-y.right,h=i-y.bottom,_=y.top;if(t.strokeStyle=L,t.lineWidth=1,t.beginPath(),t.moveTo(f,_),t.lineTo(f,h),t.lineTo(v,h),t.stroke(),!e||e.length===0){t.fillStyle=z,t.font="12px Inter, system-ui, sans-serif",t.textAlign="center",t.fillText(s.emptyLabel||"No data yet",(f+v)/2,(h+_)/2);return}let g=1/0,u=-1/0,$=0,b=-1/0;for(const l of e){const d=l[p],c=l[x];d<g&&(g=d),d>u&&(u=d),c>b&&(b=c)}u===g&&(u=g+1),b===0&&(b=1);const k=l=>f+(l-g)*(v-f)/(u-g),T=l=>h-(l-$)*(h-_)/(b-$);t.fillStyle=z,t.font="10px JetBrains Mono, monospace",t.textAlign="right",t.textBaseline="middle";const I=4;for(let l=0;l<=I;l++){const d=$+(b-$)*(l/I),c=T(d);t.strokeStyle=l===0?L:"rgba(90,72,56,0.45)",t.beginPath(),t.moveTo(f,c),t.lineTo(v,c),t.stroke(),t.fillText(q(d),f-6,c)}t.textAlign="center",t.textBaseline="top";for(let l=0;l<=3;l++){const d=g+(u-g)*(l/3),c=k(d);t.fillText(`${Math.round(d)}s`,c,h+6)}t.strokeStyle=m,t.lineWidth=2,t.beginPath();for(let l=0;l<e.length;l++){const d=k(e[l][p]),c=T(e[l][x]);l===0?t.moveTo(d,c):t.lineTo(d,c)}t.stroke(),t.lineTo(k(e[e.length-1][p]),h),t.lineTo(k(e[0][p]),h),t.closePath();const C=t.createLinearGradient(0,_,0,h);C.addColorStop(0,E(m,.3)),C.addColorStop(1,E(m,.02)),t.fillStyle=C,t.fill(),s.title&&(t.fillStyle="#e8a020",t.font="bold 12px Inter, system-ui, sans-serif",t.textAlign="left",t.textBaseline="top",t.fillText(s.title,f,0))}function q(o){return o>=1e3?(o/1e3).toFixed(1)+"k":Math.abs(o)<1?o.toFixed(2):Math.round(o).toString()}function E(o,e){const s=o.match(/^#([0-9a-f]{6})$/i);if(!s)return`rgba(232,160,32,${e})`;const t=parseInt(s[1],16);return`rgba(${t>>16&255},${t>>8&255},${t&255},${e})`}class Y{constructor(e,s,t={}){this.manager=e,this.audio=s,this._tab=t.tab||"party",this._selectedCharId=null,this._filterLog="all",this._lifetimeOnly=!!t.lifetimeOnly}onEnter(){M(),j("stats-styles",J),this._el=B("div","stats-screen"),document.body.appendChild(this._el),this._lifetimeOnly&&(this._tab="lifetime"),this._render()}onExit(){this._el&&w(this._el),D(this._el),this._el=null}destroy(){this._el&&w(this._el),D(this._el),this._el=null}update(){}draw(){}_render(){const e=this._lifetimeOnly?[["lifetime","Lifetime"],["achievements","Achievements"]]:[["party","Party"],["lifetime","Lifetime"],["achievements","Achievements"]];this._el.innerHTML=`
    ...
    `}_statCell(e,s){return`<div class="st-cell"><div class="st-cell-label">${e}</div><div class="st-cell-value">${this._fmt(s)}</div></div>`}_fmt(e){return typeof e!="number"?String(e):e>=1e6?(e/1e6).toFixed(1)+"M":e>=1e3?(e/1e3).toFixed(1)+"k":Math.round(e).toString()}_logTagLabel(e){return e==="major_kill"?"Boss":e==="elite_kill"?"Elite":e==="near_death"?"Near Death":e==="death"?"Fell":e==="story"?"Story":e}_renderLifetime(){const e=H(),s=e.global||{},t=(e.runHistory||[]).slice(0,20);return`
    ...
    `}_renderAchievements(){const{current:e,life:s}=K(),t=S.length;return`
      <div class="st-ach">
