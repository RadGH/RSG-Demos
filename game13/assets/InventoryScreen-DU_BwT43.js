      ...
      <div class="inv-layout">
        ...
        <div class="equip-panel">
          <div class="panel-label panel-label-row">
            <span>Inventory</span>
            ${r&&!(r.isCompanion&&r.class==="companion")?(()=>{var h;return(h=k.get())!=null&&h.manualCombat?"":F()?`<button type="button" class="auto-toggle hard-locked" id="inv-autoequip" aria-disabled="true" title="Auto-equip disabled on Hard difficulty" disabled>
