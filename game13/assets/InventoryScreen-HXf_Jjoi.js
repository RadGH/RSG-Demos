import{i as A,c as z,h as X,G as k,o as O,p as G,j as V,q as Y,s as Q,t as B,v as P,w as J,y as Z,z as ee,B as te,D as F,E as oe,F as j,H as ie,I as D,J as N,K as U,r as E,L as ae,N as se,O as ne,Q as re}from"./play-sHrkshvb.js";import"./savesClient-DUFjgBxb.js";const le=["weapon","offhand","head","chest","legs","hands","feet","ring1","ring2","necklace"],ce={weapon:"Weapon",offhand:"Off-hand",head:"Head",chest:"Chest",legs:"Legs",hands:"Hands",feet:"Feet",ring1:"Ring",ring2:"Ring",necklace:"Necklace"};function de(H,t,e){var u;const m=[...t.inventory||[]];let s=0;for(const r of m){if((u=t.isManuallyUnequipped)!=null&&u.call(t,r.id))continue;const b=H.autoEquip;H.autoEquip=!0;try{const a=t.tryAutoEquip(r);a&&a.member&&a.member.id===H.id&&s++}catch{}H.autoEquip=b}s>0&&e&&e.playSfx("purchase")}class be{constructor(t,e){this.manager=t,this.audio=e,this._el=null,this._selectedCharIdx=0,this._charScrollPos=new Map,this._tt=null,this._compareMode=!1,this._compareSecondary=!1,this._currentTooltipItem=null,this._isTouch=typeof window<"u"&&("ontouchstart"in window||navigator.maxTouchPoints>0)}onEnter(){this._build()}_build(){A("inv-styles",pe),this._el=z("div","inv-screen"),this.manager.uiOverlay.appendChild(this._el),this._render()}_render(){X(this._el,()=>this._renderImpl())}_renderImpl(){const t=k.get(),m=(t.inventoryContext||"default")==="party-inactive",s=t.bench||[],u=m?[...t.party,...t.companions,...s]:[...t.party,...t.companions];if(t.inventoryFocusId){const a=u.findIndex(h=>h.id===t.inventoryFocusId);a>=0&&(this._selectedCharIdx=a),t.inventoryFocusId=null}const r=u[this._selectedCharIdx]||u[0];this._selectedCharIdx>=u.length&&(this._selectedCharIdx=0),this._el.innerHTML=`
    ...
    `,this._wireEvents(),Y(this._el);const b=this._el.querySelector("#stats-base-chk");b&&b.addEventListener("click",()=>{var o,i;const a=(o=this._el)==null?void 0:o.querySelector(".equip-panel"),h=a?a.scrollTop:0,g=!b.classList.contains("on");Q(g),this.audio.playSfx("click"),this._render();const x=(i=this._el)==null?void 0:i.querySelector(".equip-panel");x&&(x.scrollTop=h)})}_slotsForItem(t,e){if(!e||!t)return[];const m=[];return e.type==="weapon"?(m.push("weapon"),(e.offHandOk||!e.twoHanded)&&!e.twoHanded&&m.push("offhand"),m):e.subtype==="ring"||e.slot==="ring"?["ring1","ring2"]:e.slot?[e.slot]:e.subtype?[e.subtype]:[]}_upgradeTier(t,e){var b;if(!t||!e||t.isCompanion&&t.class==="companion")return null;const m=this._slotsForItem(t,e);if(!m.length)return null;const s=t.equipment||{};for(const a of m)if(!s[a]){if(a==="offhand"&&((b=s.weapon)!=null&&b.twoHanded))continue;return"empty"}const u=B(e,t).total;let r=-1/0;for(const a of m){const h=s[a];if(!h)continue;const g=B(h,t).total;if(g<=0)continue;const x=(u-g)/g;x>r&&(r=x)}return r<=0||r===-1/0?null:r<=.05?"minor":r<=.2?"medium":r<=.5?"major":"huge"}_vsItemForCompare(t,e){if(!t||!e)return null;const m=t.equipment||{},s=this._slotsForItem(t,e);if(!s.length)return null;let u=s[0],r=s[1];s.includes("ring1")&&s.includes("ring2")&&(u="ring1",r="ring2");const b=this._compareSecondary&&r?r:u;return{vs:m[b]||null,slot:b,hasSecondary:!!r&&r!==u}}_openCompareModal(t,e,m={}){if(!t)return;const{hero:s=null,slotLabel:u=null,hasSecondary:r=!1,inInv:b=!1,onEquip:a}=m;A("inv-cmp-modal-styles",`
    ...
    `;const i=()=>{o.remove(),this._activeCmpModal=null};o.addEventListener("click",l=>{l.target===o&&i()});const c=l=>{l.key==="Escape"&&(i(),window.removeEventListener("keydown",c))};window.addEventListener("keydown",c),o.querySelectorAll("[data-modal-action]").forEach(l=>{l.addEventListener("click",d=>{d.stopPropagation();const v=l.dataset.modalAction;if(v==="close")i(),window.removeEventListener("keydown",c);else if(v==="equip")i(),window.removeEventListener("keydown",c),a&&a(t);else if(v==="secondary"){this._compareSecondary=!this._compareSecondary;const $=k.get().party||[],_=$[this._selectedCharIdx]||$[0],y=this._vsItemForCompare(_,t),w=o.querySelector(".inv-cmp-equipped-body"),C=o.querySelector(".inv-cmp-section-label.equipped");y!=null&&y.vs&&w?w.innerHTML=P(y.vs,s):w&&(w.innerHTML=`<span style="color:#60d080;font-style:italic">Slot ${(y==null?void 0:y.slot)||""} is empty.</span>`),C&&(C.textContent=`Equipped (${(y==null?void 0:y.slot)||"slot"})`)}})}),document.body.appendChild(o),this._activeCmpModal=o;const n=o.querySelector(".inv-cmp-modal-close");n&&n.focus()}_renderCharStats(t){if(!t)return'<div class="stat-row"><span>No character selected</span></div>';const e=t.baseAttrs||t.attrs,m=t.attrs,s=J(),u=t.equipment||{};let r=0;for(const p of Object.values(u))p!=null&&p.armor&&(r+=p.armor);const b=0,a=Z(t);r+=a.armor||0;const h=ee(u),g=s?e:{STR:m.STR+(a.str||0),DEX:m.DEX+(a.dex||0),INT:m.INT+(a.int||0),CON:m.CON+(a.con||0)},x=te(u)+(a.dmg||0),o=F(g,s?0:x,h),i=F(e,0,h),c=h==="magic"?"Magic Damage":h==="light"?"Light Damage":"Heavy Damage",n=s?0:a.magicResist||0,l=(p,q)=>({hp:q?se(t):50+p.CON*10,mp:q?ae(t):30+p.INT*8,hit:Math.min(95,70+Math.round(p.DEX*1.2)+(q&&a.hit||0)),dodge:Math.min(40,5+Math.round(p.DEX*.8)+(q&&a.dodge||0)),spl:p.INT*.025+(q&&a.spellPower||0)}),d=l(s?e:g,!s),v=l(e,!1),f=s?b:r,$=s?0:oe(t).resistAll||0,_=j(f,$),y=j(b,0),w=(p,q,T)=>{const R=ne(q,T,p);return R?` style="color:${R}"`:""},C=["STR","DEX","INT","CON"].map(p=>{const q=p.toLowerCase(),T=g[p];return`<div class="stat-row"><span class="sr-label stat-label" data-stat="${p}">${p}</span><span class="sr-val"${w(q,T,e[p])}>${Math.floor(T)}</span></div>`}).join(""),I=new Set(["str","dex","int","con","hp","mp","dmg","armor","hit","dodge","magicresist","magicResist","spellpower","spellPower"]),L={goldFind:"Gold Find",xpFind:"XP Find",manaRegen:"Mana Regen",lifeSteal:"Life Steal",manaSteal:"Mana Steal",initiative:"Initiative",critChance:"Crit Chance",critDamage:"Crit Damage",spellPower:"Spell Power",tradePrices:"Trade Prices"},S=[];if(!s){try{const p=ie(t);if((p==null?void 0:p.blockChance)>0){const q=`+${D(p.blockChance)}`;S.push(`<div class="stat-row"><span class="sr-label stat-label" data-stat="Block Chance">Block Chance</span><span class="sr-val" style="color:#6db3ff">${q}</span></div>`)}(p==null?void 0:p.blockPower)>0&&S.push(`<div class="stat-row"><span class="sr-label stat-label" data-stat="Block Power">Block Power</span><span class="sr-val" style="color:#6db3ff">+${Math.round(p.blockPower)}</span></div>`)}catch{}for(const p of Object.keys(a)){if(I.has(p)||I.has(p.toLowerCase()))continue;const q=a[p];if(!q)continue;const T=L[p]||p.replace(/([A-Z])/g," $1").replace(/^./,W=>W.toUpperCase()),K=(p==="goldFind"||p==="xpFind"||p==="critChance"||p==="critDamage"||p==="tradePrices")&&Math.abs(q)<=3?`+${D(q)}`:p==="lifeSteal"||p==="manaSteal"?`+${N(q,"pct")}`:`+${N(q,"auto")}`;S.push(`<div class="stat-row"><span class="sr-label stat-label" data-stat="${T}">${T}</span><span class="sr-val" style="color:#6db3ff">${K}</span></div>`)}}const M=S.length?S.join(""):'<div class="stat-row"><span class="sr-label" style="color:#5a4a42;font-style:italic">None</span><span class="sr-val" style="color:#5a4a42">—</span></div>';return`
      ...
      <div class="stat-row"><span class="sr-label stat-label" data-stat="Damage Reduction">Damage Reduction</span><span class="sr-val"${w("dmgReduction",_.totalDr,y.totalDr)}>${D(_.totalDr)}</span></div>
      ...
      ${M}
    `}_doEquip(t,e,m,s){t.equipment||(t.equipment={}),e.twoHanded&&e.type==="weapon"&&t.equipment.offhand&&(k.addToInventoryRaw(t.equipment.offhand),delete t.equipment.offhand),t.equipment[m]&&k.addToInventoryRaw(t.equipment[m]),t.equipment[m]=e,k.removeFromInventory(e.id),k.unmarkManuallyUnequipped(e.id),U(t)}_showSlotPicker(t,e,m){var a,h;const s=z("div","slot-picker-overlay"),u=(a=t.equipment)==null?void 0:a.weapon,r=(h=t.equipment)==null?void 0:h.offhand,b=u==null?void 0:u.twoHanded;s.innerHTML=`
      <div class="spo-box">
    ...
    `,e.querySelector("#info-ok").addEventListener("click",()=>E(e)),e.addEventListener("click",m=>{m.target===e&&E(e)}),this._el.appendChild(e)}_equipItemFlow(t){var h,g,x,o,i,c;const e=k.get(),s=[...e.party,...e.companions][this._selectedCharIdx];if(!s||!t)return;if(s.isCompanion&&s.class==="companion"){this._showInfoModal("Companions cannot equip items.");return}const u=t.type==="weapon",r=t.twoHanded,b=t.offHandOk||!r&&u;if(u&&!r&&b){const n=!!((h=s.equipment)!=null&&h.weapon),l=!!((g=s.equipment)!=null&&g.offhand),d=(o=(x=s.equipment)==null?void 0:x.weapon)==null?void 0:o.twoHanded;if(!n){this._doEquip(s,t,"weapon",e),this._render();return}if(!l&&!d){this._doEquip(s,t,"offhand",e),this._render();return}this._showSlotPicker(s,t,e);return}if(t.subtype==="ring"){const n=!!((i=s.equipment)!=null&&i.ring1),l=!!((c=s.equipment)!=null&&c.ring2);if(!n){this._doEquip(s,t,"ring1",e),this._render();return}if(!l){this._doEquip(s,t,"ring2",e),this._render();return}this._showRingPicker(s,t,e);return}let a=t.slot;a||(u?a="weapon":a=t.subtype),this._doEquip(s,t,a,e),this._render()}_wireEvents(){var x;(x=this._el.querySelector("#inv-close"))==null||x.addEventListener("click",()=>{this.audio.playSfx("click"),this.manager.pop()});const t=this._el.querySelector("#inv-autoequip");t&&t.addEventListener("click",()=>{if(O())return;this.audio.playSfx("click");const o=k.get(),c=[...o.party,...o.companions,...o.bench||[]][this._selectedCharIdx];if(!c)return;const n=!c.autoEquip;c.autoEquip=n,n&&de(c,o,this.audio),this._render()}),this._el.querySelectorAll(".char-tab").forEach(o=>{o.addEventListener("click",()=>{this.audio.playSfx("click");const i=this._el.querySelector(".inv-items-panel")||this._el.querySelector(".equip-panel");i&&this._charScrollPos.set(this._selectedCharIdx,i.scrollTop),this._selectedCharIdx=parseInt(o.dataset.idx),this._render(),requestAnimationFrame(()=>{var n,l;const c=((n=this._el)==null?void 0:n.querySelector(".inv-items-panel"))||((l=this._el)==null?void 0:l.querySelector(".equip-panel"));c&&(c.scrollTop=this._charScrollPos.get(this._selectedCharIdx)||0)})})}),this._el.querySelectorAll("[data-equip]").forEach(o=>{o.addEventListener("click",()=>{var y,w,C,I,L,S;this.audio.playSfx("click");const i=o.dataset.equip,c=k.get(),l=[...c.party,...c.companions][this._selectedCharIdx],d=c.inventory.find(M=>M.id===i);if(!l||!d)return;if(l.isCompanion&&l.class==="companion"){this._showInfoModal("Companions cannot equip items.");return}const v=d.type==="weapon",f=d.twoHanded,$=d.offHandOk||!f&&v;if(v&&!f&&$){const M=!!((y=l.equipment)!=null&&y.weapon),p=!!((w=l.equipment)!=null&&w.offhand),q=(I=(C=l.equipment)==null?void 0:C.weapon)==null?void 0:I.twoHanded;if(!M){this._doEquip(l,d,"weapon",c),this._render();return}if(!p&&!q){this._doEquip(l,d,"offhand",c),this._render();return}this._showSlotPicker(l,d,c);return}if(d.subtype==="ring"){const M=!!((L=l.equipment)!=null&&L.ring1),p=!!((S=l.equipment)!=null&&S.ring2);if(!M){this._doEquip(l,d,"ring1",c),this._render();return}if(!p){this._doEquip(l,d,"ring2",c),this._render();return}this._showRingPicker(l,d,c);return}let _=d.slot;_||(v?_="weapon":_=d.subtype),this._doEquip(l,d,_,c),this._render()})}),this._el.querySelectorAll("[data-slot]").forEach(o=>{o.dataset.itemid&&o.addEventListener("click",()=>{var v;const i=k.get(),n=[...i.party,...i.companions][this._selectedCharIdx],l=o.dataset.slot;if(!((v=n==null?void 0:n.equipment)!=null&&v[l]))return;this.audio.playSfx("click");const d=n.equipment[l];k.markManuallyUnequipped(d.id),k.addToInventoryRaw(d),delete n.equipment[l],U(n),this._render()})});const e=this._el.querySelector("#inv-tt"),m=e==null?void 0:e.querySelector(".inv-tt-body"),s=e==null?void 0:e.querySelector(".inv-tt-close"),u=()=>{const o=k.get(),i=[...o.party,...o.companions,...o.bench||[]];return{gs:o,char:i[this._selectedCharIdx]}},r=o=>{const{gs:i,char:c}=u();return i.inventory.find(n=>n.id===o)||Object.values((c==null?void 0:c.equipment)||{}).find(n=>(n==null?void 0:n.id)===o)},b=o=>{var c;if(!m||!o)return;const{char:i}=u();if(this._compareMode){const n=this._vsItemForCompare(i,o),l=(n==null?void 0:n.vs)||null,d=(n==null?void 0:n.slot)||null;let v=null;n!=null&&n.hasSecondary&&(v=this._isTouch?'Tap "Compare 2nd" below to compare against the other slot.':"Hold Alt+Shift to compare against the other slot.");let f="";if(this._isTouch&&(f+=`<div class="tt-breadcrumb">Inventory <span class="bc-sep">›</span> ${o.name} <span class="bc-sep">›</span> <strong>Compare</strong></div>`),f+=re(o,l,{hero:i,slotLabel:d,secondaryHint:v}),this._isTouch){const $=!!((c=gs==null?void 0:gs.inventory)!=null&&c.find(_=>_.id===o.id));f+=`<div class="tt-cmp-actions">
          ...
          </div>`}m.innerHTML=f}else{let n="";if(this._isTouch&&(n+=`<div class="tt-breadcrumb">Inventory <span class="bc-sep">›</span> <strong>${o.name}</strong></div>`),n+=P(o,i),this._isTouch){const l=this._slotsForItem(i,o),v=!!k.get().inventory.find(f=>f.id===o.id);l.length&&(n+=`<div class="tt-cmp-actions">
