const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/StatsScreen-D20gyFAl.js","assets/play-CPOmgDyp.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/savesClient-Dh5r3e2b.js","assets/version-JAtod6b2.js","assets/play-BnSWl064.css"])))=>i.map(i=>d[i]);
import{i as n,c as p,r as o,G as d,g as c,p as m,R as l,_ as g,a as f}from"./play-CPOmgDyp.js";import"./modulepreload-polyfill-B5Qt9EMX.js";import"./savesClient-Dh5r3e2b.js";import"./version-JAtod6b2.js";class k{constructor(e,r){this.manager=e,this.audio=r,this.noGameMenuEsc=!0}onEnter(){n("rip-styles",u),this._el=p("div","rip-screen"),document.body.appendChild(this._el),this._render()}onExit(){o(this._el),this._el=null}destroy(){o(this._el),this._el=null}update(){}draw(){}_render(){const e=d.get(),r=e.rip||{},t=[...e.party||[],...e.companions||[]],s=r.date?new Date(r.date).toLocaleString():"—";this._el.innerHTML=`
    ...
    `,this._el.querySelector("#rip-close").addEventListener("click",()=>{this.audio.playSfx("click"),this.manager.pop()}),this._el.querySelector("#rip-back").addEventListener("click",()=>{this.audio.playSfx("click"),this.manager.pop()}),this._el.querySelector("#rip-stats").addEventListener("click",async()=>{this.audio.playSfx("click");const{StatsScreen:i}=await g(async()=>{const{StatsScreen:a}=await import("./StatsScreen-D20gyFAl.js");return{StatsScreen:a}},__vite__mapDeps([0,1,2,3,4,5]));this.manager.push(new i(this.manager,this.audio,{tab:"party"}))})}_collectLog(e){const r=[];for(const t of e)for(const s of f(t.id))r.push({...s,who:t.name});return r.sort((t,s)=>(s.ts||0)-(t.ts||0)),r}_fmt(e){return e>=1e3?(e/1e3).toFixed(1)+"k":Math.round(e).toString()}}const u=`
