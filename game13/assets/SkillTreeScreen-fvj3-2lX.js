import{w as me,y as de,z as ue,B as ge,D as K,E as be,F as Y,H as fe,L as V,N as G,O as he,G as w,o as F,i as ve,c as ke,R as Z,T as J,p as xe,j as _e,q as ye,s as Q,S as W,U as ee,V as te,C as we,W as j,K as se,r as ae}from"./play-BOH4PgaX.js";import{showConfirmModal as ne}from"./ConfirmModal-DMDyAS1j.js";import"./savesClient-DUFjgBxb.js";const $e={pet_skeletal_warrior:{id:"pet_skeletal_warrior",name:"Skeletal Warrior",className:"Companion",class:"companion",isCompanion:!0,isPet:!0,ownerClass:"necromancer",level:1,attrs:{STR:12,DEX:8,INT:4,CON:14},description:"Undead soldier bound by dark magic. Fights with hollow determination."},pet_bone_golem:{id:"pet_bone_golem",name:"Bone Golem",className:"Companion",class:"companion",isCompanion:!0,isPet:!0,ownerClass:"necromancer",level:1,attrs:{STR:16,DEX:4,INT:2,CON:18},description:"Massive construct of fused bones. Slow but devastating."},pet_wolf:{id:"pet_wolf",name:"Forest Wolf",className:"Companion",class:"companion",isCompanion:!0,isPet:!0,ownerClass:"druid",level:1,attrs:{STR:10,DEX:14,INT:4,CON:10},description:"A wild wolf bonded through nature magic. Swift and loyal."},pet_bear:{id:"pet_bear",name:"Cave Bear",className:"Companion",class:"companion",isCompanion:!0,isPet:!0,ownerClass:"druid",level:1,attrs:{STR:14,DEX:6,INT:4,CON:16},description:"A massive bear called from the deep woods. Absorbs punishment."},pet_imp:{id:"pet_imp",name:"Bound Imp",className:"Companion",class:"companion",isCompanion:!0,isPet:!0,ownerClass:"warlock",level:1,attrs:{STR:6,DEX:12,INT:12,CON:6},description:"A mischievous lesser demon. Small but cunning."},pet_demon:{id:"pet_demon",name:"Infernal Hound",className:"Companion",class:"companion",isCompanion:!0,isPet:!0,ownerClass:"warlock",level:1,attrs:{STR:14,DEX:10,INT:8,CON:12},description:"A summoned demon beast from the lower planes."},pet_war_hound:{id:"pet_war_hound",name:"Trained War Hound",className:"Companion",class:"companion",isCompanion:!0,isPet:!0,ownerClass:"ranger",level:1,attrs:{STR:10,DEX:14,INT:6,CON:10},description:"An armored hunting dog trained for battle."},pet_fire_elemental:{id:"pet_fire_elemental",name:"Fire Elemental",className:"Companion",class:"companion",isCompanion:!0,isPet:!0,ownerClass:"pyromancer",level:1,attrs:{STR:8,DEX:8,INT:16,CON:8},description:"A living flame summoned from the ember planes."},pet_lightning_elemental:{id:"pet_lightning_elemental",name:"Lightning Elemental",className:"Companion",class:"companion",isCompanion:!0,isPet:!0,ownerClass:"stormcaller",level:1,attrs:{STR:6,DEX:14,INT:14,CON:6},description:"A crackling bolt given form and purpose."},pet_familiar:{id:"pet_familiar",name:"Arcane Familiar",className:"Companion",class:"companion",isCompanion:!0,isPet:!0,ownerClass:"mage",level:1,attrs:{STR:4,DEX:10,INT:16,CON:8},description:"A mystical black cat wreathed in arcane runes, bound to its mage by ancient pact."},pet_clockwork_turret:{id:"pet_clockwork_turret",name:"Clockwork Turret",className:"Companion",class:"companion",isCompanion:!0,isPet:!0,ownerClass:"tinker",level:1,attrs:{STR:12,DEX:8,INT:10,CON:14},sprite:"clockwork_turret",description:"A brass tripod turret with a single arcane-blue eye. Springs wound tight, barrel loaded with rune-etched bolts."}};let L=null;function ie(){L&&L.parentNode&&L.parentNode.removeChild(L),L=null}function Se(p,t){const r=t.getBoundingClientRect(),e=p.getBoundingClientRect();let d=r.left+r.width/2-e.width/2,s=r.top-e.height-10;d<10&&(d=10),d+e.width>window.innerWidth-10&&(d=window.innerWidth-e.width-10),s<10&&(s=r.bottom+10),p.style.left=`${d}px`,p.style.top=`${s}px`}function oe(p,t,r={}){if(!p)return()=>{};const e=r.className||"rsg-tooltip",d=g=>{ie();const b=t();if(!b)return;const m=document.createElement("div");m.className=e,m.innerHTML=b,document.body.appendChild(m),L=m,Se(m,g.currentTarget||p)},s=()=>ie();p.addEventListener("mouseenter",d),p.addEventListener("mouseleave",s);let a=null;const i=g=>{clearTimeout(a),a=setTimeout(()=>d(g),350)},n=()=>{clearTimeout(a),setTimeout(s,1500)},o=()=>{clearTimeout(a),s()};return p.addEventListener("touchstart",i,{passive:!0}),p.addEventListener("touchend",n),p.addEventListener("touchcancel",o),()=>{p.removeEventListener("mouseenter",d),p.removeEventListener("mouseleave",s),p.removeEventListener("touchstart",i),p.removeEventListener("touchend",n),p.removeEventListener("touchcancel",o),clearTimeout(a)}}function le(){if(document.getElementById("rsg-tooltip-styles"))return;const p=document.createElement("style");p.id="rsg-tooltip-styles",p.textContent=`
  ...
  `,document.head.appendChild(p)}function Ce(p){return p==="magic"?"Magic Damage":p==="light"?"Light Damage":"Heavy Damage"}function Pe(p,t={}){const{withSpendButtons:r=!1,pendingAttrPoints:e=0,includeHeader:d=!1,headerLabel:s=r?"Attributes":"Character Stats",baseToggleId:a="stats-base-chk"}=t;if(!p)return'<div class="stat-row"><span>No character selected</span></div>';const i=p.baseAttrs||p.attrs||{STR:8,DEX:8,INT:8,CON:8},n=p.attrs||i,o=me(),g=p.equipment||{};let b=0;for(const c of Object.values(g))c!=null&&c.armor&&(b+=c.armor);const m=0,u=de(p);b+=u.armor||0;const v=ue(g),x=o?i:{STR:(n.STR||8)+(u.str||0),DEX:(n.DEX||8)+(u.dex||0),INT:(n.INT||8)+(u.int||0),CON:(n.CON||8)+(u.con||0)},h=ge(g)+(u.dmg||0),l=K(x,o?0:h,v),f=K(i,0,v),y=Ce(v),M=o?0:u.magicResist||0,P=(c,k)=>({hp:k?G(p):50+c.CON*10,mp:k?V(p):30+c.INT*8,hit:Math.min(95,70+Math.round(c.DEX*1.2)+(k&&u.hit||0)),dodge:Math.min(40,5+Math.round(c.DEX*.8)+(k&&u.dodge||0)),spl:+(c.INT*.025+(k&&u.spellPower||0)).toFixed(2)}),_=P(o?i:x,!o),C=P(i,!1),O=o?m:b,N=o?0:be(p).resistAll||0,R=Y(O,N),X=Y(m,0),$=(c,k,S)=>{const E=he(k,S,c);return E?` style="color:${E}"`:""},U=["STR","DEX","INT","CON"].map(c=>{const k=c.toLowerCase(),S=x[c],E=$(k,S,i[c]);if(r){const I=e>0;return`
        ...
        </div>`}return`<div class="stat-row"><span class="sr-label stat-label" data-stat="${c}">${c}</span><span class="sr-val"${E}>${Math.floor(S)}</span></div>`}).join(""),H=new Set(["str","dex","int","con","hp","mp","dmg","armor","hit","dodge","magicresist","magicResist","spellpower","spellPower"]),z={goldFind:"Gold Find",xpFind:"XP Find",manaRegen:"Mana Regen",lifeSteal:"Life Steal",manaSteal:"Mana Steal",initiative:"Initiative",critChance:"Crit Chance",critDamage:"Crit Damage",spellPower:"Spell Power",tradePrices:"Trade Prices"},A=[];if(!o){try{const c=fe(p);if((c==null?void 0:c.blockChance)>0){const k=`+${(c.blockChance*100).toFixed(1).replace(/\.0$/,"")}%`;A.push(`<div class="stat-row"><span class="sr-label stat-label" data-stat="Block Chance">Block Chance</span><span class="sr-val" style="color:#6db3ff">${k}</span></div>`)}(c==null?void 0:c.blockPower)>0&&A.push(`<div class="stat-row"><span class="sr-label stat-label" data-stat="Block Power">Block Power</span><span class="sr-val" style="color:#6db3ff">+${Math.round(c.blockPower)}</span></div>`)}catch{}for(const c of Object.keys(u)){if(H.has(c)||H.has(c.toLowerCase()))continue;const k=u[c];if(!k)continue;const S=z[c]||c.replace(/([A-Z])/g," $1").replace(/^./,pe=>pe.toUpperCase()),ce=(c==="goldFind"||c==="xpFind"||c==="critChance"||c==="critDamage"||c==="tradePrices")&&Math.abs(k)<=3?`+${(k*100).toFixed(1).replace(/\.0$/,"")}%`:c==="lifeSteal"||c==="manaSteal"?`+${Math.round(k*10)/10}%`:`+${Math.round(k*100)/100}`;A.push(`<div class="stat-row"><span class="sr-label stat-label" data-stat="${S}">${S}</span><span class="sr-val" style="color:#6db3ff">${ce}</span></div>`)}}const T=A.length?A.join(""):'<div class="stat-row"><span class="sr-label" style="color:#5a4a42;font-style:italic">None</span><span class="sr-val" style="color:#5a4a42">—</span></div>',B=d?`<div class="panel-label">${s}</div>`:"",D=`<button type="button" class="auto-toggle stats-base-toggle${o?" on":""}" id="${a}" aria-pressed="${o?"true":"false"}" title="Show base attributes (without item bonuses)">${o?'<span class="auto-check" aria-hidden="true">✓</span>':'<span class="auto-check auto-off" aria-hidden="true">○</span>'}Show Base Attributes</button>`,q=`
    ...
    <div class="stat-row" title="Armor ${(R.armorDr*100).toFixed(1)}% + Misc ${(R.miscDr*100).toFixed(1)}% (multiplicative)"><span class="sr-label stat-label" data-stat="Damage Reduction">Damage Reduction</span><span class="sr-val"${$("dmgReduction",R.totalDr,X.totalDr)}>${(R.totalDr*100).toFixed(1)}%</span></div>
    ...
    <div class="stat-row"><span class="sr-label stat-label" data-stat="${y}">${y}</span><span class="sr-val"${$("dmg",l[1],f[1])}>${Math.floor(l[0])}-${Math.floor(l[1])}</span></div>
  ...
  `}const re={active:"auto_active",passive:"auto_passive",attrs:"auto_attrs"},Te={active:"pendingSkillPoints",passive:"pendingPassivePoints",attrs:"pendingAttrPoints"},Ae={active:"Auto-spend talent points",passive:"Auto-spend passive points",attrs:"Auto-spend attribute points"},Ee={active:"Talent points will be auto-spent on each level-up using the class default order. You will not get a chance to pick talents yourself until you turn this off.",passive:"Passive points will be auto-spent on each level-up using the class default order. You will not get to choose which passives to learn until you turn this off.",attrs:"Attribute points will be auto-spent on each level-up using the class default priority. You will not get to choose which attributes to raise until you turn this off."};function Me(p){if(!p||typeof p!="object")return[];const t=[],r=s=>`${Math.round(s*100)}%`,e=s=>`${s} round${s===1?"":"s"}`,d={targets:s=>`Hits ${s} targets`,damageMult:s=>`Damage: ${s}x multiplier`,damage_mult:s=>`Damage: ${s}x multiplier`,dmgBuff:s=>`+${r(s)} party damage`,dmgReduct:s=>`-${r(s)} damage taken`,reflect:s=>`Reflects ${r(s)} damage back`,duration:s=>`Lasts ${e(s)}`,aoe:s=>`Area: ${s}`,tempHp:s=>`+${s} temporary HP per member`,healMult:s=>`Heals ${s}x multiplier`,attackSpeed:s=>`+${r(s)} attack speed`,mpCost:s=>s<0?`Mana cost -${Math.abs(s)}`:`Mana cost +${s}`,bleed:s=>`Applies Bleed (${e((s==null?void 0:s.duration)??s)})`,statusEffects:s=>Array.isArray(s)?s.map(a=>`${Math.round((a.chance||1)*100)}% chance: ${a.type} (${e(a.duration)})`).join(", "):String(s),status_apply:s=>`Applies ${s}`,immuneStun:s=>s?"Immune to Stun":"",immuneBleed:s=>s?"Immune to Bleed":"",unlocksCompanion:s=>`Unlocks companion: ${s}`};for(const[s,a]of Object.entries(p)){if(a==null||a===!1)continue;const i=d[s];if(i){const n=i(a);n&&t.push(n)}else{const n=s.replace(/_/g," ").replace(/([A-Z])/g," $1").trim(),o=typeof a=="object"?JSON.stringify(a):String(a);t.push(`${n}: ${o}`)}}return t}class Be{constructor(t,r){this.manager=t,this.audio=r,this._el=null,this._selectedCharIdx=0,this._selectedSkill=null,this._mobileDetailView=!1,this._tab="active"}onEnter(){try{const t=w.get(),r=(t==null?void 0:t.party)||[];let e=-1;t!=null&&t.skillFocusId&&(e=r.findIndex(s=>s&&s.id===t.skillFocusId),t.skillFocusId=null),e<0&&(e=r.findIndex(s=>s&&(s.pendingSkillPoints||0)+(s.pendingPassivePoints||0)+(s.pendingAttrPoints||0)>0)),e>=0&&(this._selectedCharIdx=e);const d=r[this._selectedCharIdx];d&&!this._tabPinned&&((d.pendingSkillPoints||0)>0?this._tab="active":(d.pendingPassivePoints||0)>0?this._tab="passive":(d.pendingAttrPoints||0)>0&&(this._tab="attrs")),this._tabPinned=!1;for(const s of r){if(!s||!s.autoBuild||F())continue;const a=this._tab;for(const i of["active","passive","attrs"]){if(!s.autoBuild[`auto_${i}`])continue;this._tab=i;const n=this._selectedCharIdx;this._selectedCharIdx=r.indexOf(s);let o=0;for(;this._applyOneRecommended(s)&&o++<200;);this._selectedCharIdx=n}this._tab=a}}catch{}this._build()}_build(){ve("skill-styles",Ne),this._el=ke("div","skill-screen"),this.manager.uiOverlay.appendChild(this._el),this._render()}_render(){var b,m,u,v,x,h;const r=w.get().party,e=r[this._selectedCharIdx],d=e?Z(e.class):[],s=e?J(e.class,e.level||1):[],a=(e==null?void 0:e.talentsPurchased)||{},i={};for(const l of[".skill-list-panel",".skill-detail-panel",".passive-panel",".attrs-panel"]){const f=this._el.querySelector(l);f&&(i[l]=f.scrollTop)}const n=window.scrollY||document.documentElement.scrollTop,o=document.activeElement;if(o&&o!==document.body&&typeof o.blur=="function")try{o.blur()}catch{}this._el.innerHTML=`
      <div class="skill-header">
        <div class="skill-char-tabs" id="skill-char-tabs">
          ${r.map((l,f)=>{const y=(l.pendingSkillPoints||0)+(l.pendingPassivePoints||0)+(l.pendingAttrPoints||0),M=y>0&&f!==this._selectedCharIdx;return`
            <button type="button" class="sct-tab${f===this._selectedCharIdx?" active":""}" data-idx="${f}">
              <span class="sct-portrait">${xe(l,24)}</span>
              ${l.name} ${_e(l,12,"sct-class-icon")}<br><small>${l.className||l.class} Lv${l.level||1}</small>
      ...
      <div class="skill-mode-tabs">
        <button type="button" class="smt-tab${this._tab==="active"?" active":""}${(b=e==null?void 0:e.autoBuild)!=null&&b.auto_active?" auto-on":""}" data-mode="active">
          Spells${e&&(e.pendingSkillPoints||0)>0?` <span class="smt-badge" title="Unspent talent points — click an option to spend">+${e.pendingSkillPoints}</span>`:""}${(m=e==null?void 0:e.autoBuild)!=null&&m.auto_active?' <span class="smt-auto-check" aria-label="Auto on" title="Auto on">✓</span>':""}
        </button>
        <button type="button" class="smt-tab${this._tab==="passive"?" active":""}${(u=e==null?void 0:e.autoBuild)!=null&&u.auto_passive?" auto-on":""}" data-mode="passive">
          Passive${e&&(e.pendingPassivePoints||0)>0?` <span class="smt-badge" title="Unspent passive points — click an option to spend">+${e.pendingPassivePoints}</span>`:""}${(v=e==null?void 0:e.autoBuild)!=null&&v.auto_passive?' <span class="smt-auto-check" aria-label="Auto on" title="Auto on">✓</span>':""}
        </button>
        <button type="button" class="smt-tab${this._tab==="attrs"?" active":""}${(x=e==null?void 0:e.autoBuild)!=null&&x.auto_attrs?" auto-on":""}" data-mode="attrs">
          Attributes${e&&(e.pendingAttrPoints||0)>0?` <span class="smt-badge" title="Unspent attribute points — click an option to spend">+${e.pendingAttrPoints}</span>`:""}${(h=e==null?void 0:e.autoBuild)!=null&&h.auto_attrs?' <span class="smt-auto-check" aria-label="Auto on" title="Auto on">✓</span>':""}
        </button>
      </div>
      ...
      <div class="skill-layout${this._mobileDetailView?" mobile-detail-open":""}">
        ...
        <div class="skill-list-panel">
          ...
          ${e?`<div class="passive-points-banner pp-banner-compact" style="margin-bottom:0.65rem" title="Unspent talent points — click an option to spend"><span class="pp-num pp-num-fixed">+${e.pendingSkillPoints||0}</span><span class="pp-tip-pop">Unspent talent points — click an option to spend</span></div>`:""}
          ${d.map(l=>{const f=s.find(y=>y.name===l.name);return`
              <div class="skill-row${f?"":" locked"}${this._selectedSkill===l.name?" selected":""}" data-skill="${l.name}">
        ...
        <div class="skill-detail-panel">
          ${this._selectedSkill?this._renderSkillDetail(e,a):`
            <div class="skill-select-prompt">Select a skill to view its description and upgrade talents.</div>
          `}
        </div>
      </div>
      `}
    `,this._wireEvents(),ye(this._el);const g=this._el.querySelector("#skill-stats-base");g&&g.addEventListener("click",()=>{const l=!g.classList.contains("on");Q(l),this._render()});for(const l of Object.keys(i)){const f=this._el.querySelector(l);f&&(f.scrollTop=i[l])}window.scrollTo(0,n)}_renderSkillDetail(t,r){var g,b,m,u,v,x,h;const e=Object.values(W).find(l=>l.name===this._selectedSkill);if(!e)return"";const d=e.talents||[],s=(t==null?void 0:t.pendingSkillPoints)||0;let a=null,i=null;if(t){const l=t.attrs||{},f=de(t),y={STR:(l.STR||8)+(f.str||0),DEX:(l.DEX||8)+(f.dex||0),INT:(l.INT||8)+(f.int||0),CON:(l.CON||8)+(f.con||0)},M=y.INT*.025+(f.spellPower||0);var n=e;try{n=ee(e,t)}catch{}if(e.damageStat){const P=e.damageStat,_=I=>y[I.toUpperCase()]||0,C=/int|spell/i.test(P)||["fire","ice","lightning","holy","necro","magic"].includes(e.type),O=+n.damageMult||0;let N={};try{N=(typeof te=="function"?(g=te().combat)==null?void 0:g.skill:null)||{}}catch{}const R=N.heroDamageMult??1,X=(((m=(b=t==null?void 0:t.equipment)==null?void 0:b.weapon)==null?void 0:m.weaponCategory)||((v=(u=t==null?void 0:t.equipment)==null?void 0:u.weapon)==null?void 0:v.subtype)||"").toLowerCase(),$=n.damageCategory||(C?"magic":/2h|hammer|maul/.test(X)?"heavy":"light"),U=$==="magic"?N.magicMult??.78:$==="heavy"?N.heavyMult??1:N.lightMult??1,H=O*R*U;let z=null;try{z=w.get()}catch{}const A=!!(z!=null&&z.weaponScaling),T=(x=t==null?void 0:t.equipment)==null?void 0:x.weapon,B=(T==null?void 0:T.damage)||(T==null?void 0:T.dmg)||[],D=B.length===2?(B[0]+B[1])/2:0,q=A?D:P==="str_int"?(_("str")+_("int"))/2:_(P),c=Math.round((y.STR||8)*1.5),k=C?M:c*.05,S=C?0:Math.round(D*.1),E=q*H*(1+k)+S;a=Math.max(0,Math.round(E)),e.__estTip={sv:q,finalMult:H,powerBonus:k,weaponFlavor:S,weaponMid:D,isMagic:C,ws:A,cat:$}}if(e.healStat){const P=e.healStat,_=y[P.toUpperCase()]||0;i=Math.round((+n.healMult||0)*_*(1+M))}}let o=e;try{t&&(o=ee(e,t))}catch{}return`
      <div class="skill-detail-inner">
        ...
        ${(h=e.statusEffects)!=null&&h.length?`
          <div class="sd-effects">
            ${e.statusEffects.map(l=>`<div class="sd-effect"><span class="eff-name">${l.type.toUpperCase()}</span> ${Math.round(l.chance*100)}% chance · ${l.duration} rounds</div>`).join("")}
          </div>
        `:""}
        ${d.length?`
          <div class="sd-talents-title">Upgrade Talents</div>
          <div class="sd-talents">
            ${d.map(l=>{const f=r[l.id],y=!f&&s>0;return`
                <div class="sd-talent${f?" purchased":""}">
                  <div class="sdt-info">
                    <div class="sdt-name">${l.name}</div>
                    <div class="sdt-desc">${l.desc}</div>
                  </div>
                  <button type="button" class="sdt-btn${f?" done":""}" data-talent="${l.id}" ${f||!y?"disabled":""}>
    ...
    `}_renderRecommendBar(t){const r=this._tab,e=r==="active"?t.pendingSkillPoints||0:r==="passive"?t.pendingPassivePoints||0:t.pendingAttrPoints||0,d=`auto_${r}`,s=!!(t.autoBuild&&t.autoBuild[d]),a=F();return`
    ...
    `}_recommendAttr(t){const r=we.find(o=>o.id===t.class),e=(r==null?void 0:r.primaryAttr)||"STR",d=t.baseAttrs||{STR:8,DEX:8,INT:8,CON:8},s=t.attrs||{...d},a=(s[e]||0)-(d[e]||0),i=(s.CON||0)-(d.CON||0),n=a+i;return n>0&&i/n<.2?"CON":e}_recommendPassive(t){const r=j(t.class),e=t.passiveRanks||{},d=/lifesteal|life_steal|mana_regen|mana_steal|regen|lifebind|soulbind|exotic|leech|siphon/i,s=r.find(a=>d.test(a.id+" "+(a.name||"")+" "+(a.desc||""))&&(e[a.id]||0)<a.maxRank);return s?s.id:(r.find(a=>(e[a.id]||0)<a.maxRank)||{}).id||null}_recommendTalent(t){const r=Z(t.class),e=J(t.class,t.level||1),d=t.talentsPurchased||{},s=[...e].sort((a,i)=>(a.unlockLevel||0)-(i.unlockLevel||0));for(const a of s){const i=r.find(n=>n.name===a.name)||a;for(const n of i.talents||[])if(!d[n.id])return{skillName:a.name,talentId:n.id}}return null}_applyOneRecommended(t){const r=this._tab;if(r==="attrs"){if((t.pendingAttrPoints||0)<=0)return!1;const d=this._recommendAttr(t);t.attrs[d]=(t.attrs[d]||8)+1,t.pendingAttrPoints-=1;try{t.maxHp=G(t),t.maxMp=V(t)}catch{}return!0}if(r==="passive"){if((t.pendingPassivePoints||0)<=0)return!1;const d=this._recommendPassive(t);if(!d)return!1;const a=j(t.class).find(n=>n.id===d);if(!a)return!1;t.passiveRanks||(t.passiveRanks={});const i=t.passiveRanks[d]||0;return i>=a.maxRank?!1:(t.passiveRanks[d]=i+1,t.pendingPassivePoints-=1,se(t),!0)}if((t.pendingSkillPoints||0)<=0)return!1;const e=this._recommendTalent(t);return e?(t.talentsPurchased||(t.talentsPurchased={}),t.talentsPurchased[e.talentId]=!0,t.pendingSkillPoints=Math.max(0,(t.pendingSkillPoints||0)-1),this._selectedSkill=e.skillName,!0):!1}_renderPassivePanel(t){if(!t)return'<div class="passive-empty">No character selected.</div>';const r=j(t.class),e=t.passiveRanks||{},d=t.pendingPassivePoints||0;return`
      <div class="passive-panel">
        ...
        <div class="passive-nodes">
          ${r.map((s,a)=>{const i=e[s.id]||0,n=d>0&&i<s.maxRank;return`
    ...
    `}_renderAttrsPanel(t){if(!t)return'<div class="passive-empty">No character selected.</div>';const r=t.pendingAttrPoints||0,e=Pe(t,{withSpendButtons:!0,pendingAttrPoints:r,includeHeader:!1,baseToggleId:"skill-stats-base"});return`
    ...
    `}_renderAutoToggle(t,r){var a;if((a=w.get())!=null&&a.manualCombat)return"";const e=re[r],d=!!(t.autoBuild&&t.autoBuild[e]);return F()?"":`
    ...
    `}_wireEvents(){var r,e,d,s;(r=this._el.querySelector("#skill-close"))==null||r.addEventListener("click",()=>{this.audio.playSfx("click"),this.manager.pop()}),(e=this._el.querySelector("#skill-back-mobile"))==null||e.addEventListener("click",()=>{this.audio.playSfx("click"),this._mobileDetailView=!1,this._selectedSkill=null,this._render()}),this._el.querySelectorAll(".sct-tab").forEach(a=>{a.addEventListener("click",()=>{var o;this.audio.playSfx("click"),this._selectedCharIdx=parseInt(a.dataset.idx),this._selectedSkill=null,this._mobileDetailView=!1;const i=w.get(),n=(o=i==null?void 0:i.party)==null?void 0:o[this._selectedCharIdx];n&&((n.pendingSkillPoints||0)>0?this._tab="active":(n.pendingPassivePoints||0)>0?this._tab="passive":(n.pendingAttrPoints||0)>0&&(this._tab="attrs")),this._render()})}),this._el.querySelectorAll(".skill-row").forEach(a=>{a.addEventListener("click",()=>{a.classList.contains("locked")||(this.audio.playSfx("click"),this._selectedSkill=a.dataset.skill,this._mobileDetailView=!0,this._render())})}),this._el.querySelectorAll(".smt-tab").forEach(a=>{a.addEventListener("click",()=>{this.audio.playSfx("click"),this._tab=a.dataset.mode,this._selectedSkill=null,this._mobileDetailView=!1,this._render()})}),(d=this._el.querySelector("#recommend-btn"))==null||d.addEventListener("click",()=>{const i=w.get().party[this._selectedCharIdx];i&&this._applyOneRecommended(i)&&(this.audio.playSfx("spell"),this._render())}),(s=this._el.querySelector("#recommend-auto"))==null||s.addEventListener("change",a=>{if(F()){a.target.checked=!1;return}const i=w.get(),n=i.party[this._selectedCharIdx];if(!n){a.target.checked=!1;return}const o=this._tab,g=`auto_${o}`;if(a.target.checked){i.autoSkillConfirmed||(i.autoSkillConfirmed={active:!1,passive:!1,attrs:!1});const b=()=>{n.autoBuild||(n.autoBuild={}),n.autoBuild[g]=!0;let m=0;for(;this._applyOneRecommended(n)&&m++<200;);this.audio.playSfx("spell"),this._render()};if(i.autoSkillConfirmed[o]){b();return}a.target.checked=!1,ne({title:"Enable Auto-Recommend?",message:"Auto-apply recommended points on level-up for this tab? You can uncheck this later.",confirmText:"Enable Auto",cancelText:"Cancel",onConfirm:()=>{a.target.checked=!0,i.autoSkillConfirmed[o]=!0,b()}})}else n.autoBuild&&(n.autoBuild[g]=!1)}),this._el.querySelectorAll(".passive-node").forEach(a=>{le(),oe(a,()=>{const i=a.querySelector("[data-passive]"),n=i==null?void 0:i.dataset.passive,g=w.get().party[this._selectedCharIdx];if(!g||!n)return"";const m=j(g.class).find(v=>v.id===n);if(!m)return"";const u=(g.passiveRanks||{})[n]||0;return`<div class="tt-title">${m.name}</div><div class="tt-sub">Rank ${u} / ${m.maxRank}</div><div class="tt-row">${m.desc}</div>`})}),this._el.querySelectorAll("[data-passive]").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const n=w.get().party[this._selectedCharIdx];if(!n||(n.pendingPassivePoints||0)<=0)return;const o=a.dataset.passive,b=j(n.class).find(u=>u.id===o);if(!b)return;n.passiveRanks||(n.passiveRanks={});const m=n.passiveRanks[o]||0;m>=b.maxRank||(n.passiveRanks[o]=m+1,n.pendingPassivePoints-=1,se(n),this.audio.playSfx("spell"),this._render())})}),this._el.querySelectorAll("[data-attr]").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const n=w.get().party[this._selectedCharIdx];if(!n||(n.pendingAttrPoints||0)<=0)return;const o=a.dataset.attr;n.attrs||(n.attrs={STR:8,DEX:8,INT:8,CON:8}),n.attrs[o]=(n.attrs[o]||8)+1,n.pendingAttrPoints-=1;try{n.maxHp=G(n),n.maxMp=V(n)}catch{}this.audio.playSfx("spell"),this._render()})}),this._el.querySelectorAll("[data-auto-tab]").forEach(a=>{a.addEventListener("click",()=>{if(F()){this._showHardLockTip(a);return}const n=w.get().party[this._selectedCharIdx];if(!n)return;const o=a.dataset.autoTab,g=re[o],b=Te[o];if(!g)return;n.autoBuild||(n.autoBuild={});const m=!!n.autoBuild[g],u=n[b]||0,v=()=>{const l=this._tab;this._tab=o;let f=0;for(;this._applyOneRecommended(n)&&f++<200;);this._tab=l},x=l=>{n.autoBuild[g]=l,l&&v(),this.audio.playSfx("click"),this._render()};if(m&&u>0){v(),this.audio.playSfx("click"),this._render();return}if(m||u<=0){x(!m);return}const h=w.get();if(h.autoSkillConfirmed||(h.autoSkillConfirmed={active:!1,passive:!1,attrs:!1}),h.autoSkillConfirmed[o]){x(!0);return}ne({title:Ae[o]+"?",message:Ee[o],confirmText:"Enable Auto",cancelText:"Cancel",onConfirm:()=>{h.autoSkillConfirmed[o]=!0,x(!0)}})})});const t=this._el.querySelector("#skill-stats-base");t&&!t._wired&&(t._wired=!0,t.addEventListener("click",()=>{const a=!t.classList.contains("on");Q(a),this._render()})),this._el.querySelectorAll("[data-talent]").forEach(a=>{a.addEventListener("click",()=>{var b;if(a.disabled)return;const n=w.get().party[this._selectedCharIdx];if(!n||(n.pendingSkillPoints||0)<=0||(n.talentsPurchased||(n.talentsPurchased={}),n.talentsPurchased[a.dataset.talent]))return;n.talentsPurchased[a.dataset.talent]=!0,n.pendingSkillPoints=Math.max(0,(n.pendingSkillPoints||0)-1);const o=a.dataset.talent,g=Object.values(W);for(const m of g){const u=(m.talents||[]).find(v=>v.id===o);if((b=u==null?void 0:u.effect)!=null&&b.unlocksCompanion){const v=u.effect.unlocksCompanion,x=$e[v];if(x){const h={...x,id:v+"_"+n.id,templateId:v,ownerId:n.id,ownerName:n.name,level:n.level||1,attrs:{...x.attrs}},l=Math.floor(((n.level||1)-1)*.5);h.attrs.STR+=l,h.attrs.DEX+=l,h.attrs.INT+=l,h.attrs.CON+=l,h.maxHp=50+h.attrs.CON*10,h.hp=h.maxHp,h.maxMp=10+h.attrs.INT*3,h.mp=h.maxMp,w.addToCompanions(h)||w.addToBench(h)}break}}this.audio.playSfx("spell"),this._render()})}),this._el.querySelectorAll(".sd-talent").forEach(a=>{const i=a.querySelector("[data-talent]");if(!i)return;const n=i.dataset.talent;let o=null,g=null;for(const b of Object.values(W)){const m=(b.talents||[]).find(u=>u.id===n);if(m){o=m.effect,g=m.desc;break}}le(),oe(a,()=>{const b=o?Me(o):[];return!b.length&&!g?null:`${b.length?b.map(u=>`<div class="tt-row">${u}</div>`).join(""):""}`})})}_showHardLockTip(t){var a,i,n;if((a=this._el)==null?void 0:a.querySelector(".hard-lock-tip"))return;const e=document.createElement("div");e.className="hard-lock-tip",e.textContent="Auto disabled on Hard difficulty.";const d=t?t.getBoundingClientRect():null,s=(i=this._el)==null?void 0:i.getBoundingClientRect();d&&s&&(e.style.position="absolute",e.style.top=d.bottom-s.top+6+"px",e.style.left=d.left-s.left+"px"),(n=this._el)==null||n.appendChild(e),setTimeout(()=>e.remove(),2e3)}onPause(){this._el&&(this._el.style.display="none")}onResume(){this._el&&(this._el.style.display="")}update(){}draw(){}onExit(){ae(this._el),this._el=null}destroy(){ae(this._el),this._el=null}}const Ne=`
.skill-screen {
...
.pp-banner-compact { position: relative; padding: 0.25rem 0.55rem; cursor: help; }
.pp-num-fixed { min-width: 2.5em; text-align: center; display: inline-block; font-size: 1.05rem; }
.pp-tip-pop { position: absolute; left: 0; top: calc(100% + 4px); z-index: 50; background: #14101c; border: 1px solid rgba(232,160,32,0.45); padding: 0.4rem 0.6rem; border-radius: 6px; font-size: 0.7rem; color: #d8c89c; white-space: nowrap; opacity: 0; pointer-events: none; transition: opacity 0.15s ease; }
