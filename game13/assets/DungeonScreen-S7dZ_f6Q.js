import{D as b,i as m,r as c,c as l,E as h,C as f,G as o,h as _}from"./play-Ci3MXJU_.js";import"./modulepreload-polyfill-B5Qt9EMX.js";import"./savesClient-Dh5r3e2b.js";import"./version-B_LAV0MW.js";const v=`
...
`;class S{constructor(t,e,n,s,i){this.manager=t,this.audio=e,this._dungeonId=n,this._anchorNodeId=s,this._anchorZoneId=i,this._dungeon=b[n],this._stageIdx=0,this._el=null}onEnter(){if(m("dg-styles",v),!this._dungeon){console.warn("[DungeonScreen] unknown dungeonId",this._dungeonId),this.manager.pop();return}this._build()}onResume(){if(this._lastCombatVictory){if(this._lastCombatVictory=!1,this._stageIdx++,this._stageIdx>=this._dungeon.stages.length){this._showVictory();return}}else if(this._lastCombatDefeat){this._lastCombatDefeat=!1,this.manager.pop();return}this._build()}onLeave(){c(this._el),this._el=null}_build(){this._el&&c(this._el),this._el=l("div","dg-screen");const t=this._dungeon.stages[this._stageIdx],e=this._dungeon.stages.length,n=Array.from({length:e},(r,d)=>d<this._stageIdx?'<div class="pip done"></div>':d===this._stageIdx?'<div class="pip active"></div>':'<div class="pip"></div>').join(""),s=t.type,i=`Stage ${this._stageIdx+1} / ${e}`;let a="";if(s==="combat"||s==="boss"){const r=h[t.encounter],d=r?(r.enemies||[]).reduce((p,u)=>p+(u.count||1),0):0,g=s==="boss";a=`
    ...
    `,this.manager.uiOverlay.appendChild(this._el),t.xp){const s=(e.party||[]).filter(i=>i&&!(i.isCompanion||i.class==="companion"));if(s.length){const i=Math.floor(t.xp/s.length);s.forEach(a=>{a.xp=(a.xp||0)+i})}}this._el.querySelector("#dg-leave").addEventListener("click",()=>this._giveUp())}}export{S as DungeonScreen};
